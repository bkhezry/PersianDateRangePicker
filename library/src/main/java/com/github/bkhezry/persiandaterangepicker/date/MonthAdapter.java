...
public abstract class MonthAdapter extends BaseAdapter implements MonthView.OnDayClickListener {
  ...
  public static class CalendarDay {
    ...
    public CalendarDay(PersianDate persianDate) {
      year = persianDate.getPersianYear();
      month = persianDate.getPersianMonth();
      day = persianDate.getPersianDay();
    }
    ...
    private void setTime(long timeInMillis) {
      ...
      persianDate.setTimeInMillis(timeInMillis);
      month = persianDate.getPersianMonth();
      year = persianDate.getPersianYear();
      day = persianDate.getPersianDay();
    }
