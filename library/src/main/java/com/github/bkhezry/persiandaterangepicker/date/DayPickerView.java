...
public abstract class DayPickerView extends ListView implements OnScrollListener,
  PersianDatePickerDialog.OnDateChangedListener {
  ...
  private static String getMonthAndYearString(MonthAdapter.CalendarDay day) {
    ...
    mPersianDate.setPersianDate(day.year, day.month, day.day);

    String sbuf = "";
    sbuf += mPersianDate.getPersianMonthName();
    sbuf += " ";
    sbuf += mPersianDate.getPersianYear();
    return sbuf;
  }
