...
public class PersianTimePickerDialog extends DialogFragment implements PersianRadialPickerLayout.OnValueSelectedListener {
  ...
  /**
   * public PersianTimePickerDialog(Context context, int theme, OnTimeSetListener callback,
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    if (fontName != null) {
      ...
      mMinuteView.setTypeface(TypefaceHelper.get(activity, this.fontName));
      mAmPmTextView.setTypeface(TypefaceHelper.get(activity, this.fontName));
      mHourViewEnd.setTypeface(TypefaceHelper.get(activity, this.fontName));
      mMinuteViewEnd.setTypeface(TypefaceHelper.get(activity, this.fontName));
      mAmPmTextViewEnd.setTypeface(TypefaceHelper.get(activity, this.fontName));
    }
    ...
    mTimePickerEnd.initialize(getActivity(), this, mInitialHourOfDayEnd,
      mInitialMinuteEnd, mIs24HourMode, fontName);
    ...
    if (this.fontName != null) {
      mOkButton.setTypeface(TypefaceHelper.get(getDialog().getContext(), fontName));
      mCancelButton.setTypeface(TypefaceHelper.get(getDialog().getContext(), fontName));
    } else {
  ...
  private void setHour(int value, boolean announce) {
    ...
    CharSequence text = LanguageUtils.getPersianNumbers(String.format(Locale.getDefault(), format, value));
    if (tabHost.getCurrentTab() == 1) {
  ...
  private void updateDisplay(boolean allowEmptyDisplay) {
    if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
      ...
      if (tabHost.getCurrentTab() == 1) {
        ...
        mHourViewEnd.setText(LanguageUtils.getPersianNumbers(hourStr));
        mHourSpaceViewEnd.setText(LanguageUtils.getPersianNumbers(hourStr));
        mHourViewEnd.setTextColor(mUnselectedColor);
        mMinuteViewEnd.setText(LanguageUtils.getPersianNumbers(minuteStr));
        mMinuteSpaceViewEnd.setText(LanguageUtils.getPersianNumbers(minuteStr));
   ...
   * minutes, and the third will be either PersianTimePickerDialog.AM or PersianTimePickerDialog.PM.
   */
