package com.github.bkhezry.persiandaterangepicker.persiandateutils;

import java.util.GregorianCalendar;
import java.util.Locale;
import java.util.TimeZone;

public class PersianDate extends GregorianCalendar {
  ...
  protected void calculatePersianDate() {
    YearMonthDay persianYearMonthDay = PersianDate.gregorianToJalali(new YearMonthDay(this.get(PersianDate.YEAR), this.get(PersianDate.MONTH), this.get(PersianDate.DAY_OF_MONTH)));
  ...
  public void parse(String dateString) {
    PersianDate p = new PersianDateParser(dateString, delimiter)
      .getPersianDate();
